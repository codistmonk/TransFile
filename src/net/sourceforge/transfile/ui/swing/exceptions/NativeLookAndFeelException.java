 ...
 *
 */
public class NativeLookAndFeelException extends Exception {
	...
	public NativeLookAndFeelException(Throwable cause) {
		super(cause);
	}

	public NativeLookAndFeelException(String message, Throwable cause) {
		super(message, cause);
	}
